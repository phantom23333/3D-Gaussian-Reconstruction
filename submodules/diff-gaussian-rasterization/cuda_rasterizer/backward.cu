...
// Simplied version, omits gradient calculations and bin size adjustments.
...
// Simplied to improve performance
// -- omits view2gaussian gradient calculations
// -- adds detailed dL_dmean2D calculations for screenspace points.
template <int C>
